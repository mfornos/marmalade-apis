package marmalade.apis.twitter.api.tweets;
...
import marmalade.apis.twitter.api.TwitterDateDeserializer;
import marmalade.apis.twitter.api.geo.Place;
import marmalade.apis.twitter.api.text.Autolink;
import marmalade.apis.twitter.api.users.User;
